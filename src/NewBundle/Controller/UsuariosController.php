...
class UsuariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $usuarios = $em->getRepository('NewBundle:Usuarios')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('NewBundle\Form\UsuariosType', $usuario);
    ...
    {
        $deleteForm = $this->createDeleteForm($usuario);
        $editForm = $this->createForm('NewBundle\Form\UsuariosType', $usuario);
