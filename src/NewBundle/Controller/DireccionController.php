...
use NewBundle\Entity\Direccion;
use NewBundle\Entity\Usuarios;
...
class DireccionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $direccions = $em->getRepository('NewBundle:Direccion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('NewBundle\Form\DireccionType', $direccion);
    ...
    {
        $deleteForm = $this->createDeleteForm($direccion);
        $editForm = $this->createForm('NewBundle\Form\DireccionType', $direccion);
